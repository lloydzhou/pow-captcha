// terser public/pow.js -m --mangle-props > public/pow.min.js
(function() {
    ...
    function solvePOW (prefix, difficulty, maxAttempts = 1000000) {
        ...
        while (attempts < maxAttempts) {
            ...
            if (hash.startsWith(target)) {
                // console.log(`Found nonce: ${nonce}, hash: ${hash}, prefix: ${prefix}`, h);
                // console.log(`Hash: h('${prefix}${nonce}') == ${hash}`);
                return { nonce, hash };
            }
            // if (nonce % 1000 === 0) {
